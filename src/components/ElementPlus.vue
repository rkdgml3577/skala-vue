...
<template>
  <div class="practice-section">
    ...
    <p class="subtitle">
      외부 API와 무관하게 템플릿과 상태값 변동만을 관측하는 샘플입니다.
    </p>

    <el-card class="box-card">
      <template #header
        ><strong>📝 실습 1. 회원가입 Form & 인풋 제어</strong></template
      >
      <div class="card-body">
    ...
    <el-card class="box-card">
      <template #header
        ><strong>🛒 실습 2. 커머스 상품 수량 및 평점 시스템</strong></template
      >
      <div class="card-body">
        <div class="input-group">
          <span>구매 수량 선택:</span>
        ...
        <div class="result-preview">
          🟢 <strong>실시간 장부 요약:</strong> 선택 수량
          {{ productQuantity }}개 / 내가 준 점수 {{ productRate }}점
        </div>
      </div>
    </el-card>
    ...
    <el-card class="box-card">
      <template #header
        ><strong
          >⚙️ 실습 3. 시스템 피드백 & 프로그레스 인터랙션</strong
        ></template
      >
      <div class="card-body">
        <div class="btn-zone">
          <el-button type="danger" plain @click="confirmDelete"
            >🗑️ 서버 파일 삭제 테스트</el-button
          >
